...
class PolicyTrainerRayProcess(RayProcess):
    ...
    def train(
        ...
        # @gau-nernst (NOTE): this step is quite slow. we can potentially use a much larger batch size here
        # since it's no grad.
        # profiling shows this is under-utilized
        # a lot of time is spent on FA2's wrapper. specifically converting the attention mask to varlen attention.
        # TODO: understand what each collated_query_responses[i] means
